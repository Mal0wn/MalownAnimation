...
extension Color {
    ...
    static let pinkClear: Color = Color(r:255, g:200, b:221)
    static let pinkDark : Color = Color(r:255, g:175, b:204)
    static let blueClear: Color = Color(r:189, g:224, b:254)
    static let blueDark : Color = Color(r:162, g:210, b:255)
    static let darkPurple : Color = Color(r:43, g:33, b:58)
    static let oceanBlue : Color = Color(r:0, g:119, b:182)
    static let eerieBlack : Color = Color(r:33, g:37, b:41)
